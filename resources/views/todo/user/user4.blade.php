...
@section('tabs')
	<li><a href="http://users.metropolia.fi/~aleksniv/awsomeWebstore/user/user1.html">Home</a></li>
	...
	<li class="active"><a href="http://users.metropolia.fi/~aleksniv/awsomeWebstore/user/user4.html">Home Appliance</a></li>
